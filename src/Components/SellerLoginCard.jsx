...
const SellerLoginCard = () => {
    ...
    const onSubmit = async (e) => {
        ...
        try{
            const res = await axios.post('http://localhost/projects/foor-delivery/seller-login.php', data)
        console.log(res)
        if (res.data.status === 'success') {
            // alert('first')
            setSuccess(true)
            setSellerLoginDetails(data.email)
            console.log(data)
            // alert('second')
        ...
        <div className='form-cont-screen-fix'>
            ...
            <form action="" onSubmit={onSubmit}>
                <div className="reg-emp">
                    ...
                    <div className="reg-emp-item">
                        <Button variant="contained"><Link to='/seller-registration'>Create Account</Link></Button>
                    </div>
                </div>
            </form>
...
export default SellerLoginCard